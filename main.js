...
const copiaOperaciones = operaciones.map((operacion, index, array) => {
    let operacionCambiada = { ...operacion }
    operacionCambiada.monto = String(operacionCambiada.monto)
    return operacionCambiada
...
const filtroOperaciones = operaciones.filter((operacion, index, array) => {
